...
<a href="https://bartoszmilewski.files.wordpress.com/2014/12/monoid.jpg"><img class="aligncenter wp-image-3683 size-medium" style="border:1px solid #000000;" src="https://bartoszmilewski.files.wordpress.com/2014/12/monoid.jpg?w=236&#038;h=300" alt="Monoid" width="236" height="300" /></a>
...
<div data-shortcode="caption" id="attachment_3681" style="width: 310px" class="wp-caption aligncenter"><a href="https://bartoszmilewski.files.wordpress.com/2014/12/monoidhomset.jpg"><img class="wp-image-3681 size-medium" src="https://bartoszmilewski.files.wordpress.com/2014/12/monoidhomset.jpg?w=300&#038;h=197" alt="Monoid hom-set seen as morphisms and as points in a set" width="300" height="197" /></a><p class="wp-caption-text">Monoid hom-set seen as morphisms and as points in a set
</div>
...
<li>Considering that Bool is a set of two values True and False, show that it forms two (set-theoretical) monoids with respect to, respectively, operator `&&` (AND) and `||` (OR).</li>
